 ...
 *
 *
 * $Id: ParameterItemProvider.java,v 1.9 2008/02/21 20:09:38 Michal Antkiewicz <mantkiew@gsd.uwaterloo.ca> $
 */
...
/**
 * This is the item provider adapter for a {@link ca.uwaterloo.gsd.applet.Parameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AppletPackage.Literals.PARAMETER__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		EList<String> labels = ((Parameter)object).getName();
		return labels.size() == 0 ?
			getString("_UI_Parameter_type") :
			getString("_UI_Parameter_type") + " '" + labels.toString() + "'";
	}
