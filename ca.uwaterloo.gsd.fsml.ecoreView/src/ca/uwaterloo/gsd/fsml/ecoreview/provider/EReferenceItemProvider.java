    ...
    IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
    ...
    return overlayImage(
    		...
    		getComposedImage(
    				...
    				getResourceLocator().getImage(
    						(reference.isContainment() ? "full/obj16/ContainmentEReference" : "full/obj16/EReference"))));
  }
  ...
  public String getText(Object object)
  {
    ...
    if (!eReference.isContainment() && eReference.getEType() != null) {
      result.append(" : ");
  ...
  public Collection getChildren(Object object) {
	  ...
	  if (reference.isContainment()) {
		  ...
		  // find all subclasses of the referenceType
		  
		  children.add(referenceType);
			
		  for (Object aux : referenceType.getEPackage().getEClassifiers()) {
			if (aux instanceof EClass && aux != referenceType) {
