...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.ecore.EFactory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EFactoryItemProvider
    ...
    IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
  ...
  {
    EFactory eFactory = (EFactory)object;
    StringBuffer result = new StringBuffer();
    if (eFactory.getEPackage() != null)
    {
      result.append(eFactory.getEPackage().getName());
    }
