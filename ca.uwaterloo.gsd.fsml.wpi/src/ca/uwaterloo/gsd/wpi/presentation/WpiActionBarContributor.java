 ...
 *
 *
 * $Id: WpiActionBarContributor.java,v 1.6 2007/12/06 03:28:41 Michal Antkiewicz <mantkiew@gsd.uwaterloo.ca> $
 */
...
/**
 * This is the action bar contributor for the Wpi model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WpiActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(WpiEditPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(WpiEditPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	 ...
	 * @generated
	 */
	public WpiActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("wpi-settings"));
		toolBarManager.add(new Separator("wpi-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(WpiEditPlugin.INSTANCE.getString("_UI_WpiEditor_menu"), "ca.uwaterloo.gsd.wpiMenuID");
		...
		//
		createChildMenuManager = new MenuManager(WpiEditPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(WpiEditPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(WpiEditPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(WpiEditPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
