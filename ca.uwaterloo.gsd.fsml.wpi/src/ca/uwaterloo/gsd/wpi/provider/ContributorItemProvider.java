 ...
 *
 *
 * $Id: ContributorItemProvider.java,v 1.6 2008/01/18 19:22:29 Michal Antkiewicz <mantkiew@gsd.uwaterloo.ca> $
 */
...
/**
 * This is the item provider adapter for a {@link ca.uwaterloo.gsd.wpi.Contributor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ContributorItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Contributor_contributor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Contributor_contributor_feature", "_UI_Contributor_type"),
				 WpiPackage.Literals.CONTRIBUTOR__CONTRIBUTOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WpiPackage.Literals.CONTRIBUTOR__EXTENDS_EDITOR_ACTION_BAR_CONTRIBUTOR);
		}
	...
	public String getText(Object object) {
		String label = ((Contributor)object).getContributor();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WpiPackage.Literals.CONTRIBUTOR__EXTENDS_EDITOR_ACTION_BAR_CONTRIBUTOR,
				 WpiFactory.eINSTANCE.createExtendsEditorActionBarContributor()));
	}
