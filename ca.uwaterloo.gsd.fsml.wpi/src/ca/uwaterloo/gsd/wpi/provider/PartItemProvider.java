 ...
 *
 *
 * $Id: PartItemProvider.java,v 1.6 2007/07/17 04:18:30 Michal Antkiewicz <mantkiew@gsd.uwaterloo.ca> $
 */
...
/**
 * This is the item provider adapter for a {@link ca.uwaterloo.gsd.wpi.Part} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PartItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WpiPackage.Literals.PART__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPackagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Part_package_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Part_package_feature", "_UI_Part_type"),
				 WpiPackage.Literals.PART__PACKAGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLocalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Part_local_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Part_local_feature", "_UI_Part_type"),
				 WpiPackage.Literals.PART__LOCAL,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Part.class)) {
			case WpiPackage.PART__NAME:
			case WpiPackage.PART__PACKAGE:
			case WpiPackage.PART__LOCAL:
