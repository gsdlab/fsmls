...
public class EcoreAttributeValuePage extends WizardPage implements
		Listener {
	...
	public EcoreAttributeValuePage(String pageName,EAttribute attribute) {
		super(pageName);
		this.setTitle("Select Attribute Value");
	...
	public void createControl(Composite parent) {
		...
		addPropertyWizardPageToComposite(parent);
		setControl(parent);			
	}
    ...
    private void addPropertyWizardPageToComposite(Composite composite) {
		...
		if (attribute.getEType().getInstanceClassName().equals("char")||attribute.getEType().getInstanceClassName().equals("byte")||
			...
			new Label (composite, SWT.NONE).setText("Enter a value for the " + attribute.getEContainingClass().getName()+"'s "+attribute.getName()+" ("+attribute.getEType().getInstanceClassName() + ") attribute.");
		    booleanCombo = new Combo(composite, SWT.BORDER | SWT.READ_ONLY);
