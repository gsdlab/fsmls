...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>variant assigned With New Initializer</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link ca.uwaterloo.gsd.fsml.implModel.impl.variant_assignedWithNew_InitializerImpl#getInitializedType <em>Initialized Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class variant_assignedWithNew_InitializerImpl extends variant_assignedWithNewImpl implements variant_assignedWithNew_Initializer {
	/**
	 ...
	 * @generated
	 */
	protected variant_assignedWithNew_InitializerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ImplModelPackage.Literals.VARIANT_ASSIGNED_WITH_NEW_INITIALIZER;
	}
	...
	public void setInitializedType(String newInitializedType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImplModelPackage.VARIANT_ASSIGNED_WITH_NEW_INITIALIZER__INITIALIZED_TYPE, oldInitializedType, initializedType));
	}
...
} //variant_assignedWithNew_InitializerImpl
