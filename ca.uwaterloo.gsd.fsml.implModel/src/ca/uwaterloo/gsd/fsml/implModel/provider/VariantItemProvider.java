...
/**
 * This is the item provider adapter for a {@link ca.uwaterloo.gsd.fsml.implModel.Variant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariantItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variant_eClass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variant_eClass_feature", "_UI_Variant_type"),
				 ImplModelPackage.Literals.VARIANT__ECLASS,
				 false,
				 false,
				 false,
	...
	protected void addEStructuralFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variant_eStructuralFeature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variant_eStructuralFeature_feature", "_UI_Variant_type"),
				 ImplModelPackage.Literals.VARIANT__ESTRUCTURAL_FEATURE,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Variant)object).getEClass();
